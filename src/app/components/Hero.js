...
//             </p>
//             <form className="space-y-4 mt-4 md:mt-10">
//               <div>
//                 <label
//                   htmlFor="firstName"
...
export default function Hero() {
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="container mx-auto min-h-screen flex flex-col md:flex-row items-center justify-center px-6 md:px-12 pt-20">
        {/* Left Section */}
        <motion.div
          className="text-white max-w-md space-y-4"
          initial={{ opacity: 0, x: -50 }}
        ...
        >
          ...
          <p className="text-sm md:text-base">
            ...
            <br />
            Engage with our professional real estate agents to sell, buy or rent your home.
          </p>
        </motion.div>
        ...
        >
          ...
          <form className="space-y-4 mt-6">
            <div>
              <label htmlFor="firstName" className="block text-sm font-medium text-green-500">
                First Name*
              </label>
              <input
                id="firstName"
            ...
            <div>
              <label htmlFor="lastName" className="block text-sm font-medium text-green-500">
                Last Name*
              </label>
              <input
                id="lastName"
